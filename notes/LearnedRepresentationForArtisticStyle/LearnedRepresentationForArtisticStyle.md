...
In the classic Style Transfer Networks, a convolutional net is trained to generate an image that minimizes the sum of content-loss and style-loss. These losses (from *Gatys et al.*) are computed by extracting the deep features generated by an image classifier such as VGG. 
